#!/usr/bin/env python3
"""Look up records in the locally generated PF2e Foundry dataset."""
...
DATA_PATH = Path(__file__).with_name("data") / "pf2e_foundry.json"
BUILD_COMMAND = "python3 systems/pf2e/build_foundry.py"
